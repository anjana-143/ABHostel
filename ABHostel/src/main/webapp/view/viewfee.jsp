      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="#">
            ...
            <span class="links_name"onclick="window.location.href='<%= request.getContextPath() %>/view/Viewlogin.jsp'">View Visitor</span>
          </a>
        </li>
...
<tbody >
<% List<Fee>lstFee=(List<Fee>)request.getAttribute("lstFee"); %>
<%
if(lstFee!=null){
	for(Fee fe: lstFee){
		%>
	<tr>
	<td> <%= fe.getFee_status() %></td>
	<td> <%= fe.getStudent_name() %></td>	
