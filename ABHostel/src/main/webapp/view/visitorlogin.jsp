  ...
  <section class="home-section">
    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
        ...
        <form action="<%=request.getContextPath()%>/VisitorController"
			method="post" class="form">
    <h2>Confirm Your ID to See Visitor</h2>
    ...
    <h2>&nbsp;</h2>
		...
		<!-- <input type="submit" value="Register" class="submit-btn" onclick="window.location.href='<%= request.getContextPath() %>/view/table.jsp'"/> -->	
...
<script>
	function goToRegisterPage(){
		window.location = "viewvisitor.jsp";
	 }
</script>
</html>
