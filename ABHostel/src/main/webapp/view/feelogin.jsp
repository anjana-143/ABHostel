  ...
  <section class="home-section">
    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
        ...
        <form action="<%=request.getContextPath()%>/FeeController"
			method="post" class="form">
    <h2>Confirm your id to view Fee</h2>
    ...
    <h2>&nbsp;</h2>
		...
		<!-- <input type="submit" value="Register" class="submit-btn" onclick="window.location.href='<%= request.getContextPath() %>/view/viewfee.jsp'"/> -->	
